...
class TypeUtils {
    ...
    companion object {
        ...
        fun BigInteger.toUint128(): Uint128 {
            return Uint128(this)
        }
        ...
        fun bytes4(indexed: Boolean = false): TypeReference<Type<ByteArray>> {
            return TypeReference.create(Bytes4::class.java, indexed) as TypeReference<Type<ByteArray>>
        }
        ...
        fun uint48(): TypeReference<Uint48> {
            return TypeReference.create(Uint48::class.java)
        }
